...
# filter, because the class is integer. 
...
> Answer: we do not control the row numbers. Don't know which one you are grabbing. 
...
ex3 <- 
  ...
  filter(lakename == "Tuesday Lake", year4 %in% 1990:1999, month == 7) 
