...
BR_Rain_Decomp <- stl(rainfall_ts,s.window = "periodic")
plot(BR_Rain_Decomp)


BR_temp_Decomp <- stl(temp_ts,s.window = "periodic")
plot(BR_temp_Decomp)
...
ggplot(BR_temp_Components) +
  ...
  geom_line(aes(y = trend, x = Date), color = "pink")
  #geom_line(aes(y = seasonal, x= Date), color = "lightblue")

ggplot(BR_Rain_Components) +
  geom_line(aes(y = Observed, x = Date), size = 0.25)+
  geom_line(aes(y = trend, x = Date), color = "orange")
  #geom_line(aes(y = seasonal, x= Date), color = "lightblue")
